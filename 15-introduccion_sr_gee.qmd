...
Antes de entrar en ejemplos específicos, es vital conocer dónde buscar la información. Google Earth Engine aloja aproximadamente 120 petabytes de información espacial lista para el análisis, abarcando más de 40 años de observaciones históricas y actualizándose diariamente.
...
with open('metadatos_landsat9.json', 'w') as archivo:
    json.dump(metadatos_json, archivo, indent=4)
print("¡Archivo 'metadatos_landsat9.json' generado! (Explora sus propiedades)")
...
with open('landsat9_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
print("¡Archivo 'landsat9_serializado.json' generado! (Úsalo en la herramienta de ArcGIS Pro)")
...
Map_l9.save("map_l9.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_l9.html", width="100%", height="500px"))
```
...
Asegúrate de seguir el procedimiento de instalación y configuración de GEE en ArcGIS Pro en @sec-arcgis-pro-gee.

Antes de usar cualquier función, debemos autenticar nuestra cuenta. En la caja de herramientas de GEE dentro de ArcGIS Pro, abra la sección `Authentication Tools`:
...
with open('metadatos_sentinel2.json', 'w') as archivo:
    json.dump(metadatos_json, archivo, indent=4)

# B) Exportar Grafo Serializado (Para ArcGIS Pro)
s2_limpia = ee.Image(id_exacto)
texto_json_serializado = s2_limpia.serialize()
with open('sentinel2_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
...
# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_s2.html", width="100%", height="500px"))
```
...
with open('metadatos_sentinel1.json', 'w') as archivo:
    json.dump(metadatos_json, archivo, indent=4)

# B) Exportar Grafo Serializado (Para ArcGIS Pro)
s1_limpia = ee.Image(id_exacto)
texto_json_serializado = s1_limpia.serialize()
with open('sentinel1_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_s1.save("map_s1.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_s1.html", width="100%", height="500px"))
```
...
with open('metadatos_modis.json', 'w') as archivo:
    json.dump(metadatos_json, archivo, indent=4)

# B) Exportar Grafo Serializado (Para ArcGIS Pro)
modis_limpia = ee.Image(id_exacto)
texto_json_serializado = modis_limpia.serialize()
with open('modis_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_modis.save("map_modis.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_modis.html", width="100%", height="500px"))
```
...
with open('metadatos_srtm.json', 'w') as archivo:
    json.dump(metadatos_json, archivo, indent=4)
...
with open('srtm_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_srtm.save("map_srtm.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_srtm.html", width="100%", height="500px"))
```
...
with open('metadatos_chirps.json', 'w') as archivo:
    json.dump(metadatos_json, archivo, indent=4)

# B) Exportar Grafo Serializado (Para ArcGIS Pro)
chirps_limpia = ee.Image(id_exacto)
texto_json_serializado = chirps_limpia.serialize()
with open('chirps_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_clima.save("map_clima.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_clima.html", width="100%", height="500px"))
```
...
with open('metadatos_buildings.json', 'w') as archivo:
    json.dump(metadatos_json, archivo, indent=4)

# B) Exportar Grafo Serializado (Para ArcGIS Pro)
texto_json_serializado = buildings.serialize()
with open('buildings_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_bld.save("map_bld.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_bld.html", width="100%", height="500px"))
```
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_ntl.save("map_ntl.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_ntl.html", width="100%", height="500px"))
```
...
with open('metadatos_dswx.json', 'w') as archivo:
    json.dump(metadatos_json, archivo, indent=4)

# B) Exportar Grafo Serializado
dswx_limpia = ee.Image(id_exacto)
texto_json_serializado = dswx_limpia.serialize()
with open('dswx_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_dswx.save("map_dswx.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_dswx.html", width="100%", height="500px"))
```
...
with open('metadatos_pop.json', 'w') as archivo:
    json.dump(metadatos_json, archivo, indent=4)

# B) Exportar Grafo Serializado
pop_limpia = ee.Image(id_exacto)
texto_json_serializado = pop_limpia.serialize()
with open('pop_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_pop.save("map_pop.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_pop.html", width="100%", height="500px"))
```
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_filtro.save("map_filtro.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_filtro.html", width="100%", height="500px"))
```
...
with open('ndvi_serializado.json', 'w') as archivo:
    json.dump(texto_json_serializado, archivo)
...
# Guardamos el mapa aislado en tu carpeta de trabajo
Map_ndvi.save("map_ndvi.html")

# Lo incrustamos en el documento Quarto como una página web independiente
display(IFrame(src="map_ndvi.html", width="100%", height="500px"))
```
