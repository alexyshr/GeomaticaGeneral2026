...
![Simbología de Poblaciones](data_heavy/taller_cartografia_qgis/imagenes/simbologia_poblaciones.png){fig-align="center" width="80%"}
...
![Configuración de Popup Map Tips de la Capa Poblaciones](data_heavy/taller_cartografia_qgis/imagenes/map_tips_poblaciones_1.png){fig-align="center" width="90%"}


![Map Tips de la Capa Poblaciones](data_heavy/taller_cartografia_qgis/imagenes/map_tips_poblaciones_2.png){fig-align="center" width="70%"}
...
![qgis2web: Panel `Layers and Groups`](data_heavy/taller_cartografia_qgis/imagenes/export_to_web_map_1.png){fig-align="center" width="70%"}

![qgis2web: Panel `Layers and Groups`, opción `Popups`](data_heavy/taller_cartografia_qgis/imagenes/export_to_web_map_7.png){fig-align="center" width="70%"}
...
![qgis2web: Panel `Appearance`](data_heavy/taller_cartografia_qgis/imagenes/export_to_web_map_2.png){fig-align="center" width="50%"}

* En el panel `Export`:
  * Definir la salida a la carpeta `../data_heavy/taller_cartografia_qgis/qgis2web_output/`

![qgis2web: Panel `Export`](data_heavy/taller_cartografia_qgis/imagenes/export_to_web_map_3.png){fig-align="center" width="70%"}


* En el panel `Settings`:
  * Ver siguiente gráfica

![qgis2web: Panel `Settings`](data_heavy/taller_cartografia_qgis/imagenes/export_to_web_map_4.png){fig-align="center" width="70%"}

* En el panel `WIKI`:
  * Existe la guía para usar y configurar `qgis2web`

![qgis2web: Panel `WIKI`](data_heavy/taller_cartografia_qgis/imagenes/export_to_web_map_5.png){fig-align="center" width="70%"}

* Otras opciones:
  
  * **Framework:** seleccionar `Leaflet` (más ligero y rápido).

![qgis2web: Framework y Exportación](data_heavy/taller_cartografia_qgis/imagenes/export_to_web_map_6.png){fig-align="center" width="70%"}
...
![Instalar QGIS Server con OSGeo4W](data_heavy/taller_cartografia_qgis/imagenes/install_qgis_server_osgeo4w.png){fig-align="center" width="100%"}
...
::: {#fig-capabilities}
![](data_heavy/taller_cartografia_qgis/imagenes/configuracion_service_capabilities_QGIS_Server.png){fig-align="center" width="100%"}
...
::: {#fig-wms}
![](data_heavy/taller_cartografia_qgis/imagenes/configuracion_WMS_QGIS_Server.png){fig-align="center" width="80%"}
...
::: {#fig-wmts}
![](data_heavy/taller_cartografia_qgis/imagenes/configuracion_WMTS_QGIS_Server.png){fig-align="center" width="80%"}
...
::: {#fig-wfs}
![](data_heavy/taller_cartografia_qgis/imagenes/configuracion_WFS_OAPIF_QGIS_Server.png){fig-align="center" width="80%"}
...
::: {#fig-wcs}
![](data_heavy/taller_cartografia_qgis/imagenes/configuracion_WCS_QGIS_Server.png){fig-align="center" width="80%"}
