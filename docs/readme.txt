...
2. Proyecto
	5. Guía y Estructura del Proyecto Final
3. Tareas - Marzo 9 (Último Plazo)
4. Clase 4 y 5
	- ./presentaciones/
		3- Estructuras de Datos Vectorial.pdf (*)
		4- Estructuras de Datos Raster.pdf (*)
		5- Estructuras de Datos Vectorial TIN.pdf
		6- Raster vs Vector vs Tin.pdf
		9 - Geodatabase.pdf
	- 9  Conversión de Formatos (ArcGIS Pro - QGIS)
	- Raster y Vector
5. MOOC - ESRI - Tarea Grupal (Obtener el Certificado!) ------<<<< (listo)
...
8. Proyecto - Estado del Arte (4 - 5 papers, resumen, resumen AI, citación)
9. pUBLICAR EL LINK ARSET PARA LOS RECUERSOS HISTORICOS
https://earthdata.nasa.gov/s3fs-public/2025-05/OnlineResourceGuide_2024_Revised_V2_0.pdf?VersionId=EOGXiksocNpuRIa0TFTRac.gRe8eNEl3

10. Página reina - recursos ML - Geomática: https://www.kaggle.com/

Taller Geodatabase
Taller Model Builder - Modelos
Taller raster y vector en R


Tutorial de Determinación de Huellas Espectrales de Cobertura de Suelos con QGIS 3 y SCP 6

https://gidahatari.com/ih-es/tutorial-de-determinacion-de-huellas-espectrales-de-cobertura-de-suelos-con-qgis-3-y-scp-6
