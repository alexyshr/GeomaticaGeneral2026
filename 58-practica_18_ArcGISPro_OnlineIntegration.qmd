...
![Vinculación de base de datos](data_heavy/taller_cartografia_web/imagenes/vinculacion_gdb.png){fig-align="center" width="30%"}
...
![Creación de Mapas](data_heavy/taller_cartografia_web/imagenes/creacion_mapas.png){fig-align="center" width="25%"}
...
![Registrar Portal UNALMED en ArcGIS Pro](data_heavy/taller_cartografia_web/imagenes/agregar_portal_unalmed.png){fig-align="center" width="90%"}
...
![Registro de credenciales en ArcGIS Pro](data_heavy/taller_cartografia_web/imagenes/sign_in_arcgispro_1.png){fig-align="center" width="100%"}

![Credenciales registradas en ArcGIS Pro](data_heavy/taller_cartografia_web/imagenes/sign_in_arcgispro_2.png){fig-align="center" width="60%"}
...
![Definición del rango de escala para drenajes](data_heavy/taller_cartografia_web/imagenes/scale_range_drenajes_1.png){fig-align="center" width="100%"}

![Efecto del rango de escala para drenajes](data_heavy/taller_cartografia_web/imagenes/scale_range_drenajes_2.png){fig-align="center" width="80%"}
...
![Definición de color y transparencia para Departamentos](data_heavy/taller_cartografia_web/imagenes/color_departamentos.png){fig-align="center" width="70%"}
...
![Etiquetado para Departamentos](data_heavy/taller_cartografia_web/imagenes/labeling_dptos.png){fig-align="center" width="100%"}
...
![Opción para compartir capas Web desde la cinta/pestaña `Share`](data_heavy/taller_cartografia_web/imagenes/share_web_layer_cinta.png){fig-align="center" width="100%"}
...
![Ventana `Share As Web Layer`](data_heavy/taller_cartografia_web/imagenes/share_web_layer_ventana.png){fig-align="center" width="60%"}
...
![Opción: `Allow Assignment Of Unique Numeric IDs`](data_heavy/taller_cartografia_web/imagenes/allow_assignment_of_unique_numeric_ids.png){fig-align="center" width="70%"}
...
![Activar Mapa_Base](data_heavy/taller_cartografia_web/imagenes/activar_mapa_base.png){fig-align="center" width="70%"}
...
![Compartir Mapa_Base como capa `Vector Tile`](data_heavy/taller_cartografia_web/imagenes/share_as_web_layer_mapa_base.png){fig-align="center" width="55%"}
...
![Sección `Content` (Contenido) en ArcGIS Online](data_heavy/taller_cartografia_web/imagenes/mi_contenido_arcgis_online.png
...
![Map Viewer (Visor de Mapa) en ArcGIS Online](data_heavy/taller_cartografia_web/imagenes/map_viewer_add_capa_1.png){fig-align="center" width="100%"}


![Lista de capas de `Mi Contenido` en ArcGIS Online](data_heavy/taller_cartografia_web/imagenes/map_viewer_add_capa_2.png){fig-align="center" width="70%"}
...
![Agregar `Tile layer (alojado)` en Map Viewer](data_heavy/taller_cartografia_web/imagenes/map_viewer_add_tile_layer.png){fig-align="center" width="45%"}

* Abrir el menú de opciones (tres puntos horizontales) de la capa cargada y seleccionar `Mover al mapa base` (Move to Basemap).

![Mover un `Tile layer` de `Capas` a `Mapa Base` en el Map Viewer](data_heavy/taller_cartografia_web/imagenes/map_viewer_move_layer_al_mapa_base.png){fig-align="center" width="50%"}
...
![Vista General del Mapa Web](data_heavy/taller_cartografia_web/imagenes/vista_general_del_mapa.png){fig-align="center" width="100%"}
...
![Opciones de la Vista general del Mapa Web](data_heavy/taller_cartografia_web/imagenes/opciones_de_la_vista_general_del_mapa.png){fig-align="center" width="50%"}
