...
## [Opción B] Instalación Detallada del Entorno Nativo

La **Opción B** se basa en el instalador **OSGeo4W**, un entorno para Windows que agrupa y facilita la gestión de software geoespacial de código abierto como QGIS [@rosas2022qgis], GDAL/OGR [@mitchell2015introduction], GRASS [@neteler2012grass] y SAGA [@passy2018use].
...
## Instalación QGIS + GEE using Pixi {#sec-qgis-gee-pixi}
